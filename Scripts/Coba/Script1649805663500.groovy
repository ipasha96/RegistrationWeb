...
String Counter1 = 'donadonitasatu+' + Number + '+'

String Counter = Counter1 + '@gmail.com'

GlobalVariable.Counter = Counter

WebUI.setText(findTestObject('Object Repository/Page_Daftar Sebagai Pemberi Dana  ALAMI Pee_40e437/input_Email_email', [(GlobalVariable.Counter) : GlobalVariable.Counter]),
...
WebUI.setText(findTestObject('Object Repository/Page_Daftar Sebagai Pemberi Dana  ALAMI Pee_40e437/input_No. Handphone_phone',  [(GlobalVariable.Phone) : GlobalVariable.Phone]),
